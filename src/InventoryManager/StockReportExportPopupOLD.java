 ...
 * @author reymy
 */
public class StockReportExportPopupOLD extends javax.swing.JFrame {

    /**
     * Creates new form StockReportExportPopup
     */
    public StockReportExportPopupOLD() {
        setUndecorated(true);
        initComponents();
        setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);// Don't exit whole app
        setLocationRelativeTo(null); // Center popup
    }
    ...
    private void generateButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_generateButtonActionPerformed
        String selectedFormat = formatComboBox.getSelectedItem().toString();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StockReportExportPopupOLD.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new StockReportExportPopupOLD().setVisible(true);
            }
        });
    }
