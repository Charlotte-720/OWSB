 ...
 * @author reymy
 */
public class NotUsed_ManageInventoryEntries extends javax.swing.JFrame {

    /**
     * Creates new form ManageInventoryEntries
     */
    public NotUsed_ManageInventoryEntries() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NotUsed_ManageInventoryEntries.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NotUsed_ManageInventoryEntries().setVisible(true);
            }
        });
    }
