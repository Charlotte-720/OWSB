...
public class PRExistingItem extends javax.swing.JFrame {
    private java.util.List<Item> itemList;
    private String currentSalesManagerID;
    
     public PRExistingItem(String salesManagerID) {
    ...
    private void submitButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitButtonActionPerformed
        ...
        // Validate delivery date
            ...
            javax.swing.JOptionPane.showMessageDialog(this, 
                    "Item added to PR successfully!", "Success", 
        ...
        try {
            ...
            for (int i = 0; i < model.getRowCount(); i++) {
                if (model.getValueAt(i, 0) != null) { 
                    String itemIDValue = (String) model.getValueAt(i, 0);
                    int quantityValue = (int) model.getValueAt(i, 1);
                    double price = (double) model.getValueAt(i, 2);
                    String currentSupplierID = getSupplierID(itemIDValue);
                    
                    // Create PRItem using the constructor
                    PRItem prItem = new PRItem(
                        itemIDValue, 
                        quantityValue, 
                        getItemName(itemIDValue),
                        currentSupplierID, 
                        price, 
                        deliveryDate
                    );
